...
Page({
  ...
  onLoad: function (options) {
   ...
   that.setData({
     dizhi:yuanshuju.shiName,
     xmxqms: yuanshuju.content,
     xmname: yuanshuju.title,
     yuanshuju: yuanshuju,
     xmid: yuanshuju.id
   })
  ...
  submit: function () {
    ...
    if (dizhi == that.data.yuanshuju.shiName){
      shuju.provinceId = that.data.yuanshuju.shenid
        shuju.cityId = that.data.yuanshuju.shiid
        shuju.districtId = that.data.yuanshuju.quid
    }else{
      shuju.provinceId = sheng
      shuju.cityId = shi
      shuju.districtId = qu
    }
          ...
          success(res) {
            ...
            if (i == uploadpic.length - 1) {
              ...
              console.log(shuju)
                ...
                wx.request({
                  url: that.data.href + 'api/Administration/XCXGovernmentProjectChange',
                  method: 'POST',
